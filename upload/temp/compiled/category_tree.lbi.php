...
<dl class="clearfix" style="background: #fafafa;
...
?> 
  ...
  > <span class="f_l"><img src="themes/ecmoban_dangdang/images/btn_fold.gif" style="padding-top:10px;padding-right:6px;cursor:pointer;"></span> <a href="javascript:(0);" class="  f_l"><?php echo htmlspecialchars($this->_var['cat']['name']); ?></a>
  </h1>
...
{ 
		if(obj_ul.item(id).style.display == "block")
		{
			...
			obj_img.item(id).src = "themes/ecmoban_dangdang/images/btn_fold.gif"
			return false;
		}
		else(obj_ul.item(id).style.display == "none")
		{
			obj_ul.item(id).style.display = "block"
			obj_img.item(id).src = "themes/ecmoban_dangdang/images/btn_unfold.gif"
		}
}
</script>